...
async function main() {
    const vendedor = new Vendedor("Lais", "11345678912345", "Rua Vicente Sales, 33, Porto Belo, Cornélio Procópio - PR");
    const produto = new Produto("Teclado", "Mecânico, novo", 150, "11345678912345");
    const cliente = new Cliente("Maria", "12111111111", "ap@gmail.com", "12345", "Avenida XV de Novembro, 1595, Centro, Cornélio Procópio - PR");
